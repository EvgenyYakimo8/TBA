...
-------------------------------------------------- -------------------------------------------------- -------------------------------------------------- -------------------------------------------------- ----------------------------
The program was implemented according to the technical specifications - as the first project during training. Among the complications, the output of the report file data for a period of time and the amount of bills with a floating point "double" has been added.
