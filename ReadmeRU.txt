...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Программа реализована согласно ТЗ - как первый проект во время обучения. Из усложнений добавлен вывод данных файла-отчета за промежуток времени и суммы счетов с плавающей точкой "double".
